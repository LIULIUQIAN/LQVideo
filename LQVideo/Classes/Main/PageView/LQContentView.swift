...
@objc protocol LQContentViewDelegate : class {
    func contentView(_ contentView : LQContentView, progress : CGFloat, sourceIndex : Int, targetIndex : Int)
    
    @objc optional func contentViewEndScroll(_ contentView : LQContentView)
}
private let kContentCellID = "kContentCellID"

class LQContentView: UIView {

    // MARK: 对外属性
    weak var delegate : LQContentViewDelegate?
...
extension LQContentView : UICollectionViewDataSource {
...
extension LQContentView : UICollectionViewDelegate {
