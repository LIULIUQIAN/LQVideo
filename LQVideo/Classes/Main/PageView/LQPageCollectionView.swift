...
protocol LQPageCollectionViewDataSource : class {
...
protocol LQPageCollectionViewDelegate : class {
    func pageCollectionView(_ pageCollectionView: LQPageCollectionView, didSelectItemAt indexPath: IndexPath)
}


class LQPageCollectionView: UIView {

    weak var dataSource : LQPageCollectionViewDataSource?
    weak var delegate : LQPageCollectionViewDelegate?
    
    fileprivate var titles : [String]
    fileprivate var isTitleInTop : Bool
    fileprivate var style : LQTitleStyle
    fileprivate var layout : LQPageCollectionViewLayout
    ...
    init(frame: CGRect, titles : [String], style : LQTitleStyle, isTitleInTop : Bool, layout : LQPageCollectionViewLayout) {
        self.titles = titles
        self.style = style
...
// MARK:- 设置UI界面
extension LQPageCollectionView {
...
extension LQPageCollectionView : UICollectionViewDataSource {
...
extension LQPageCollectionView : UICollectionViewDelegate {
...
extension LQPageCollectionView : LQTitleViewDelegate {
