...
// MARK:- 定义协议
protocol LQTitleViewDelegate : class {
    func titleView(_ titleView : LQTitleView, selectedIndex index : Int)
}

class LQTitleView: UIView {

    // MARK: 对外属性
    weak var delegate : LQTitleViewDelegate?
    ...
    // MARK: 自定义构造函数
    init(frame: CGRect, titles : [String], style : LQTitleStyle) {
