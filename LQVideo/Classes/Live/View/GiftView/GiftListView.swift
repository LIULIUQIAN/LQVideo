...
class GiftListView: UIView, NibLoadable {
    ...
    fileprivate var pageCollectionView : LQPageCollectionView!
...
extension GiftListView {
    ...
    fileprivate func setupGiftView() {
        ...
        pageCollectionView = LQPageCollectionView(frame: pageViewFrame, titles: ["热门", "高级", "豪华", "专属"], style: style, isTitleInTop: true, layout : layout)
...
// MARK:- 数据设置
extension GiftListView : LQPageCollectionViewDataSource, LQPageCollectionViewDelegate {
